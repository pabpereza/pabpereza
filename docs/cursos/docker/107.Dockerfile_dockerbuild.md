...
keywords: [docker, dockerfile, docker build, construcción de imágenes, nginx, python, optimización de dockerfile, crear imágenes docker, tutorial dockerfile, docker build ejemplos]
