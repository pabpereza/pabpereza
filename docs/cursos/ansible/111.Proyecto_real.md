...
| [Manejo de errores](108.Entornos_reales.md) | Bloques block/rescue/always, assert, validaciones |
| [Include/Import y orquestación](108.Entornos_reales.md) | `site.yml` como orquestador con import_playbook |
| [Depuración](108.Entornos_reales.md) | Playbook de diagnóstico, debug, registros |
