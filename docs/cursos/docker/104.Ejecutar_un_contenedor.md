---
title: Cómo iniciar un contenedor en docker, comando docker run y opciones
description: Aprende a iniciar contenedores en Docker utilizando el comando `docker run`. Descubre las opciones más comunes para ejecutar, gestionar y visualizar contenedores en ejecución.
keywords: [docker, iniciar contenedor, docker run, mapear puertos docker, docker cli, devops]
sidebar_label: Iniciar un contenedor 
...
[![Iniciar un contenedor](https://img.youtube.com/vi/ImLoqbY9DNA/sddefault.jpg)](https://www.youtube.com/watch?v=ImLoqbY9DNA)
