...
description: >-
  Guía completa de mantenimiento de clusters Kubernetes. Aprende backup de etcd,
  actualización de versiones, troubleshooting y operaciones críticas para
  administradores.
keywords:
...
sidebar_label: 27. Mantenimiento
tags:
  - kubernetes
  - mantenimiento
  - backup
