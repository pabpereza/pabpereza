---
title: "Procedimientos Almacenados y Funciones en MySQL"
description: "Aprende a crear procedimientos (Stored Procedures) y funciones personalizadas para automatizar tareas en MySQL."
keywords:
  - procedimientos almacenados mysql
  - stored procedures mysql
  - funciones personalizadas mysql
  - create procedure mysql
  - create function mysql
  - call procedure mysql
  - procedimientos vs funciones mysql
  - lógica negocio base de datos
  - parámetros procedimientos mysql
tags: [mysql, bases-de-datos, sql]
sidebar_label: "Procedimientos y Funciones"
---
## Introducción
