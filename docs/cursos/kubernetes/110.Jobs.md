...
- **Paralelismo:** Con el parámetro `parallelism` puedes indicar cuántos pods del Job pueden ejecutarse a la vez. Por ejemplo, `completions: 5` y `parallelism: 2` ejecutará 5 tareas en total, de dos en dos.
