...
description: Aprende a gestionar imágenes de contenedor en Docker, incluyendo cómo descargarlas, eliminarlas y consultar su historial.
keywords: [docker, imágenes de contenedor, docker pull, docker search, docker rmi, docker prune, docker history, gestión de imágenes, capas de imágenes, eliminar imágenes, descargar imágenes]
