...
sidebar_label: 4. Ejecutar un contenedor
...
Podemos utilizar el contenedor de nginx como ejemplo, si hacemos una petición web o accedemos desde el navegador a localhost:80 (localhost o la IP de nuestra máquina si lo estamos haciendo en un servidor externo), no podremos acceder a él. 
