...
keywords:
  ...
  - ingress rules kubernetes
  - cert-manager kubernetes
  - configurar ingress kubernetes
  - https kubernetes
  - host-based routing kubernetes
  - path-based routing kubernetes
  - wildcard ingress kubernetes
sidebar_label: 12. Ingress Controller
tags:
  - kubernetes
  - ingress
  - nginx
...
Puedes repasar la parte de [Services](./111.Services.md) para refrescar conceptos.

Entrada de vídeo: https://youtu.be/U87QO6VxReA

[![Ingress Controller en Kubernetes](https://img.youtube.com/vi/U87QO6VxReA/maxresdefault.jpg)](https://www.youtube.com/watch?v=U87QO6VxReA)
...
Podemos instalar el ingress controller basado en nginx con [Helm](./125.Helm.md).
...
Te preguntarás: entonces, ¿tenemos que llamar a los puertos de los nodos directamente? ¿Y si tengo varios nodos? ¿Y si tengo varios ingress controllers?
