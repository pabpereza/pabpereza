...
keywords: [docker, entrypoint, cmd, argumentos, variables de entorno, dockerfile, docker run, configuración de contenedores, flexibilidad de contenedores, entorno de ejecución de contenedores]
