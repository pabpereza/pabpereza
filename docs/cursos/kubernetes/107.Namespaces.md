...
> **Consejo:** si trabajamos con muchos namespaces a diario, echemos un ojo a las herramientas `kubectx` y `kubens`, que agilizan mucho el cambio de contexto y de namespace.
