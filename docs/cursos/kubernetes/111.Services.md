...
> **Nota:** en versiones modernas de Kubernetes, los endpoints se gestionan internamente mediante `EndpointSlices`, que escalan mejor en clústeres grandes. El concepto es el mismo y puedes consultarlos con `kubectl get endpointslices`.
