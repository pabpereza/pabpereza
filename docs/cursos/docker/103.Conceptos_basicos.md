...
keywords: [docker, contenedores, imágenes, dockerfile, dockerhub, devops, ciclo de vida de un contenedor, construcción de imágenes, gestión de contenedores, repositorio de imágenes, docker commit]
