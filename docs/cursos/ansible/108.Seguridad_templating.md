...
*   `{% if ... %}`: **Lógica**. Control de flujo (condicionales, bucles).
...
Usamos el módulo [`template`](src/workflows/readme.py ) en lugar de `copy`.
