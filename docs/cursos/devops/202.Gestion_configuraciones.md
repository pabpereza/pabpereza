...
:::tip Curso completo de Ansible
Esto es solo un resumen. Si quieres dominar la herramienta, tienes un [curso de Ansible gratuito y completo](/docs/cursos/ansible) en esta web: inventarios, playbooks, roles, Vault, contenedores y CI/CD, con un vídeo por capítulo.
:::
