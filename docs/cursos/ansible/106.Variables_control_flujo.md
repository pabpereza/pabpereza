...
En el módulo 3 hemos vistocómo utilizar `when`, `loop` y handlers en su forma básica. Aquí vamos a ir un paso más allá: el sistema de variables de Ansible, los facts como fuente de verdad del sistema, y las herramientas avanzadas que convierten un playbook que se adapta a todo lo que le eches.
