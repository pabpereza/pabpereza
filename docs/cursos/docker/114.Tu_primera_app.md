...
keywords:
  ...
  - fastapi docker
  - api rest docker
  - docker compose aplicacion completa
  - despliegue aplicación docker
  - tutorial docker proyecto real
  - crear aplicación con docker
  - backend docker
  - dockerizar aplicacion python
  - docker y fastapi
  - proyecto docker desde cero
...
sidebar_label: 14. Tu primera app
...
Tenemos la aplicación en este repositorio de Github para consultar todo lo realizado en el vídeo: [Quotes](https://github.com/pabpereza/quotes)
