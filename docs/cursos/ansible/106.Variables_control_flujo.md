...
- name: Desplegar aplicación
  ...
  tasks:
    - name: Mostrar entorno detectado
      debug:
        msg: "Desplegando en {{ group_names }} con {{ ansible_facts['processor_vcpus'] }} vCPUs"

    - name: Calcular workers óptimos según CPUs
      set_fact:
        workers: "{{ [workers, ansible_facts['processor_vcpus'] * 2] | min }}"
      when: workers | int > ansible_facts['processor_vcpus'] * 2
