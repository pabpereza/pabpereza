---
title: Roles en Ansible y Ansible Galaxy - tutorial completo con ejemplos
description: >-
  Tutorial de roles en Ansible: estructura de un rol, ansible-galaxy init,
  dependencias con requirements.yml y cómo publicar o consumir roles y
  colecciones desde Ansible Galaxy. Con ejemplos en español.
keywords:
  - ansible roles
  - ansible galaxy
...
# Roles en Ansible y Ansible Galaxy: modulariza tu código
