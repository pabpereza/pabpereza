...
:::warning Cuidado con lo que declaras como "no afecta"
...
Lo tienes con laboratorios completos en el [curso de DevSecOps](../devsecops/README.md), y el pipeline entero montado en su [capítulo final](../devsecops/110.Pipeline_completo.md).
