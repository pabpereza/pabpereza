...
- **Mutating**: pueden **modificar** el objeto. Ya hemos visto varios sin saberlo: el que inyecta la service account `default`, el que aplica los valores de un [LimitRange](./117.Rangos_quotas.md) o el que inyecta el sidecar de [Istio](./305.Service_mesh.md).
