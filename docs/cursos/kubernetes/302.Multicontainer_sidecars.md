...
Si nos encontramos ambos estilos en producción es normal; para contenido nuevo, usamos el nativo.
...
Un pod `2/2 Running` tiene sus dos contenedores sanos; un `1/2` nos dice exactamente dónde mirar.
