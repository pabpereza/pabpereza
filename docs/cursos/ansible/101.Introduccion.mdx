...
:::tip Vídeo asociado
Cada capítulo del curso se corresponde con **un único vídeo** del [canal de YouTube](https://www.youtube.com/@Pabpereza). Si prefieres aprender en formato vídeo, aquí tienes el de este capítulo:
:::
