...
Fijémonos en el label `kubernetes.io/metadata.name`: Kubernetes lo pone automáticamente en todos los namespaces con su nombre, y es la forma estándar de seleccionar un namespace concreto.
...
La diferencia es un guion: dos elementos de lista (OR) frente a un único elemento con dos selectores (AND). Revisémoslo siempre dos veces.
