...
## Dockerfile
Repasamos brevemente qué es un Dockerfile y cómo se estructura. Si quieres refrescar, puedes ver la sección de [Conceptos básicos de Docker](3.Conceptos_basicos.md)
