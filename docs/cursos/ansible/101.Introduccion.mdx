---
title: Qué es Ansible y cómo funciona - instalación paso a paso
description: >-
...
Este es el capítulo 1. Ver el [índice completo del curso de Ansible](/docs/cursos/ansible).
...
:::tip Vídeo asociado
Cada capítulo del curso se corresponde con **un único vídeo** del [canal de YouTube](https://www.youtube.com/@Pabpereza). Si preferimos aprender en formato vídeo, aquí tenemos el de este capítulo:
:::

[![¿Qué es Ansible y cómo funciona? (Instalación y Laboratorio) - Curso Ansible #1](https://img.youtube.com/vi/URK1t98tNEU/maxresdefault.jpg)](https://youtu.be/URK1t98tNEU)
...
<Tabs>
  ...
  <TabItem value="macos" label="macOS">
    ...
    Si usamos Mac, la forma más sencilla y limpia es usar **Homebrew**.
  ...
  <TabItem value="pip" label="Python (Pip)">
    ...
    Esta es una opción universal si tenemos Python instalado. Es útil para entornos virtuales o si nuestra distro no tiene paquetes actualizados.
...
Vamos a montar un entorno local usando **Docker**. Si no sabemos de docker o simplemente queremos repasar, recordamos que tenemos un [curso completo de Docker aquí](../docker/README.md)
