...
Veremos que los nodos ya traen labels de serie, como `kubernetes.io/hostname`, `kubernetes.io/os` o `kubernetes.io/arch`, que también podemos usar en los selectores.
