...
> **Truco de examen:** también se puede crear un HPA básico (solo CPU) de forma imperativa con `kubectl autoscale deployment quotes-deployment --min=3 --max=10 --cpu-percent=50`. Para configuraciones con varias métricas o `behavior`, como la de arriba, necesitarás el YAML.
