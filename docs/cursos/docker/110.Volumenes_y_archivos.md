...
keywords:
  - docker
  - volúmenes docker
  - persistencia datos docker
  - montaje de archivos docker
  - bind mount vs volume
  - diferencia volumen y bind mount
  - docker cp
  - docker volume create
  - gestión de volúmenes docker
  - exportar volúmenes docker
  - copiar archivos contenedor
  - datos persistentes docker
  - docker volume ls
  - montar archivos
  - tutorial docker
sidebar_label: 10. Volúmenes y archivos
...
Esta sección gráfica se ve mejor en el vídeo, así que recomendamos verlo para entender mejor cómo funciona.
