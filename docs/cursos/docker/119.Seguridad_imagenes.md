...
Este capítulo va de la segunda. El escaneo con Trivy lo tienes en el [curso de DevSecOps](../devsecops/105.Seguridad_imagenes.md).
...
Cómo construir estas imágenes, con multi-stage, lo tienes en el [capítulo anterior](118.Multi_stage_y_distroless.md).
...
[Hadolint](https://github.com/hadolint/hadolint) analiza tu `Dockerfile` y avisa de los fallos habituales:
