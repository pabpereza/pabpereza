---
title: 🐬 Curso MySQL Gratuito - De Principiante a Experto
description: >-
  Curso completo de MySQL gratuito en español. Desde los fundamentos de SQL 
...
# Curso MySQL - De cero a Administrador de Bases de Datos
...
- **Estudiantes** que quieran una base sólida en lenguajes de consulta estructurados (SQL).
- **Analistas de Datos** que necesitan extraer y manipular información de forma eficiente.
...
* [🔄 Control de Flujo con Cursores](./108.Cursores.md) - Procesamiento fila por fila
* [⚡ Triggers: Disparadores de Eventos](./109.Triggers.md) - Automatización por acciones
* [🔒 Seguridad: Cifrado y Descifrado](./110.Cifrado_y_descifrado.md) - Protegiendo información sensible

### 🔴 Nivel Avanzado - Administración y Seguridad
*Gestión de entornos productivos y mantenimiento*

* [👤 Gestión de Usuarios](./111.Usuarios.md) - Creación y administración de cuentas
* [🛡️ Privilegios y Roles](./112.Permisos.md) - Control de acceso granular (RBAC)
* [📤 Exportación e Importación de Datos](./113.Export_import.md) - Backups y migraciones
