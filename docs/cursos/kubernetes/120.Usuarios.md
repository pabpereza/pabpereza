...
description: Aprende a gestionar usuarios, Service Accounts y autenticación en Kubernetes. Configura certificados, tokens y contextos para acceso seguro al cluster.
keywords: [kubernetes usuarios, service accounts kubernetes, autenticación kubernetes, certificados kubernetes, kubeconfig contexts, kubernetes identidades]
sidebar_label: Usuarios
tags: [kubernetes, usuarios, service-accounts, autenticación, CKA]
