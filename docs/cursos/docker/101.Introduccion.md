...
# Introducción
Bienvenido al curso de Docker en el que aprenderemos a utilizar esta tecnología en todos sus aspectos, desde la instalación hasta la implementación en producción, desde el punto de vista de un desarrollador, administrador de sistemas o DevOps.
...
Todo este curso se grabará para youtube y, en paralelo este repositorio de GitHub (aunque seguramente lo estemos viendo renderizado en mi web) me servirá de guión para los vídeos aunque también nos permitirá seguir el curso de forma paralela. Los vídeos me permitirán explayarme más en los conceptos y en la práctica, mientras que el repositorio nos permitirá tener una guía más rápida y concisa, con los comandos y ejemplos para que lo podamos copiar y acceder más rápidamente a la información.
