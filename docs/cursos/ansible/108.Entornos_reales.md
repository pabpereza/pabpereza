...
:::tip Vídeo asociado
Este capítulo se corresponde con **un único vídeo** del [canal de YouTube](https://www.youtube.com/@Pabpereza), centrado en el proyecto. Errores y depuración aparecen como secciones de apoyo dentro del mismo vídeo.
:::
