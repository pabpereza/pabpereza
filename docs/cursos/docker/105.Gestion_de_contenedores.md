...
keywords:
  ...
  - devops
  - comandos docker
  - cómo parar un contenedor docker
...
sidebar_label: 5. Gestión de contenedores
...
Deberíamos saber el ID o el nombre del contenedor que queremos parar. Recordemos que podemos ver los contenedores que tenemos en ejecución con el comando `docker ps`.
...
Deberíamos saber el ID o el nombre del contenedor que queremos iniciar. Recordemos que podemos ver los contenedores que tenemos parados con el comando `docker ps -a`. Este nos mostrará todos los contenedores, tanto los que están en ejecución como los que están parados.
