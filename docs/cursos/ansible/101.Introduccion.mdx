...
:::tip Vídeo asociado
Este capítulo se corresponde con **un único vídeo** del [canal de YouTube](https://www.youtube.com/@Pabpereza). Si prefieres aprender en formato vídeo, búscalo en la lista de reproducción del curso.
:::
